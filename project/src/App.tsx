...
import CompleteProfilePhotographer from './pages/service_provider_form/CompleteProfilePhotographer';
import CompleteProfileVenue from './pages/service_provider_form/CompleteProfileVenue';
import CompleteProfileMakeupArtist from './pages/service_provider_form/CompleteProfileMakeupArtist';
import CompleteProfileDecorator from './pages/service_provider_form/CompleteProfileDecorator';
import CompleteProfileCaterer from './pages/service_provider_form/CompleteProfileCaterer';
  ...
  return (
    <ServiceProviderProfileProvider>
      <Routes>
        ...
        <Route path="*" element={<>{console.log('Fallback route hit!')}<Navigate to="/dashboard" replace /></>} />
      </Routes>
    </ServiceProviderProfileProvider>
  );
}
