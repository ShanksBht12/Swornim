    ...
    <section className="w-full mb-16">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="body-medium text-slate-500">Showcasing our finest decoration designs</p>
        </div>
...
const QuickInfoSection = ({ decorator }: { decorator: any }) => {
  const infoCards = [
    {
      icon: Award,
      label: "Status",
      value: decorator.user?.userType === "decorator" ? "Verified Professional" : "Unverified",
      bgColor: decorator.user?.userType === "decorator" ? "bg-green-50" : "bg-slate-50",
      iconColor: decorator.user?.userType === "decorator" ? "text-green-600" : "text-slate-500",
      valueColor: decorator.user?.userType === "decorator" ? "text-green-700 font-semibold" : "text-slate-600",
    },
    {
      icon: Star,
      label: "Rating",
      value: `${decorator.rating || 0} (${decorator.totalReviews || 0} reviews)`,
    ...
    },
    {
      icon: MapPin,
      label: "Location",
      value: decorator.location?.name || "Location not specified",
      bgColor: "bg-blue-50",
    ...
    },
    {
      icon: CheckCircle,
      label: "Availability",
      value: decorator.isAvailable ? "Available Now" : "Currently Busy",
      bgColor: decorator.isAvailable ? "bg-green-50" : "bg-red-50",
      iconColor: decorator.isAvailable ? "text-green-600" : "text-red-600",
      valueColor: decorator.isAvailable ? "text-green-700 font-medium" : "text-red-700 font-medium",
    },
    {
      icon: Eye,
      label: "Profile Views",
    ...
    },
    {
      icon: Calendar,
      label: "Starting Rate",
      value: decorator.hourlyRate ? `₹${decorator.hourlyRate}/hr` : "Contact for pricing",
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {card.label === "Availability" && (
                      <div className="flex items-center gap-2 mt-2">
                        <div
                          className={`w-2 h-2 rounded-full ${decorator.isAvailable ? "bg-green-500" : "bg-red-500"} animate-pulse`}
                        ></div>
                        <span className="body-small text-slate-500">
                          {decorator.isAvailable ? "Ready to book" : "Check back later"}
                        </span>
                      </div>
                    )}
                  </div>
...
const AboutSection = ({ decorator }: { decorator: any }) => (
      ...
      <div className="prose prose-slate max-w-none">
        <p className="body-large leading-relaxed text-slate-700">
          {decorator.description ||
            "We are passionate decoration professionals dedicated to transforming spaces into beautiful, memorable environments. Our creative vision and attention to detail bring your dream events to life with stunning visual impact."}
        </p>
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div className="card p-6">
        ...
        <div className="flex flex-wrap gap-3">
          {(decorator.specializations || []).length > 0 ? (
            decorator.specializations.map((tag: string, idx: number) => (
      ...
      <div className="card p-6">
        <h4 className="headline-small mb-4 text-slate-800">Equipment & Materials</h4>
        <div className="flex flex-wrap gap-3">
          {(decorator.equipment || []).length > 0 ? (
            decorator.equipment.map((item: string, idx: number) => (
    ...
    <div className="card p-8 bg-gradient-to-r from-blue-50 via-white to-purple-50">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="text-center group">
          ...
          <div className="display-medium text-slate-800 font-bold mb-1">{decorator.experienceYears || 0}</div>
        ...
        <div className="text-center group">
          ...
          <div className="display-medium text-slate-800 font-bold mb-1">{decorator.totalReviews || 0}</div>
        ...
        <div className="text-center group">
          ...
          <div className="display-medium text-slate-800 font-bold mb-1">{decorator.rating || 0}</div>
        ...
        <div className="text-center group">
          ...
          <div className="body-small text-slate-500 font-medium">Events Decorated</div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div className="text-center py-16">
        <div className="card p-12 bg-gradient-to-br from-slate-50 to-slate-100 max-w-md mx-auto">
          ...
          <p className="body-medium text-slate-500 mb-6">
            We create personalized decoration packages tailored to your event theme and budget.
          </p>
  ...
  return (
    <div className="space-y-8">
      <div className="text-center mb-10">
        <h3 className="headline-large mb-3">Decoration Packages</h3>
              ...
              <div className="text-center mb-8">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center justify-center gap-2 mt-2">
                    ...
                    <span className="body-medium text-slate-600">{pkg.durationHours} hours setup</span>
                  </div>
                </div>
              </div>
...
const DecoratorDetail = () => {
  ...
  useEffect(() => {
    ...
    decoratorService
      ...
      .catch((err) => {
        setError("Failed to load decorator details")
        setLoading(false)
      })
  }, [id])
      ...
      <div className="container py-16">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center space-y-4">
            ...
            <p className="body-large text-slate-600">Loading decorator details...</p>
          </div>
        </div>
      </div>
    )
  ...
  if (!decorator) {
    return (
      <div className="container py-16">
        <div className="text-center">
          <div className="card p-12 max-w-md mx-auto">
            <p className="headline-medium text-slate-600 mb-4">Decorator Not Found</p>
            <p className="body-medium text-slate-500 mb-6">
              The decorator you're looking for doesn't exist or has been removed.
            </p>
            <Link to="/client-dashboard" className="btn-primary">
              Back to Dashboard
            </Link>
      ...
      <div className="container py-8 section-spacing">
        ...
        <div className="grid lg:grid-cols-5 gap-8 mb-16">
              ...
              <div className="mt-6 space-y-4">
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <h1 className="headline-large text-slate-900">{decorator.businessName}</h1>
                    {decorator.user?.userType === "decorator" && (
          ...
          <div className="lg:col-span-3">
            <QuickInfoSection decorator={decorator} />
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              <ReviewsSection reviews={decorator.reviews || []} />
            </div>
          </div>
        </div>
      </div>
