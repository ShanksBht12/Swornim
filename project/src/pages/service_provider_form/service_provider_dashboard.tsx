...
const ServiceProviderDashboard = () => {
  ...
  const handlePortfolioUpload = async () => {
    ...
    try {
      const results = await Promise.all(
        portfolioImageFiles.map(file => uploadPortfolioImages([file]))
      );
        ...
        <div className="card p-6 bg-gradient-to-br from-slate-50 to-blue-50">
          ...
          {portfolioImageFiles.length > 0 && (
            <div className="mt-4 flex items-center gap-3">
              ...
              >
                {uploadingPortfolio ? 'Uploading...' : `Upload ${portfolioImageFiles.length} Image${portfolioImageFiles.length > 1 ? 's' : ''}`}
              </button>
              <button
                ...
                >
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-start space-x-6">
                      ...
                      />
                      <div>
                        <div className="text-xl font-bold text-slate-800 mb-3">{booking.service || booking.serviceName || booking.packageName}</div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <span className="text-slate-600 font-medium">{booking.location || booking.eventLocation}</span>
                          </div>
                          <div className="flex items-center space-x-3">
                            <div className="p-2 bg-green-50 rounded-lg">
                              <Phone className="w-4 h-4 text-green-600" />
                            </div>
                            <span className="text-slate-600 font-medium">{booking.contact || booking.providerContact || '-'}</span>
                          </div>
                        </div>
                        {booking.eventType && (
                          <div className="flex items-center space-x-3">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-slate-800 mb-2">{booking.amount || booking.totalAmount}</div>
                      <span
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-slate-200">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <button
                          ...
                          onClick={async () => {
                            ...
                            try {
                              ...
                              setBookings((prev) =>
                                prev.map((b) =>
                                  b.id === booking.id ? { ...b, status: 'cancelled_by_provider' } : b
                                )
                              );
                            } catch (err) {
                      ...
                      {canRaiseDispute && (
                        <button /* raise dispute logic placeholder */>Raise Dispute</button>
                      )}
                    </div>
                  </div>
                </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <form className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 hover:shadow-lg transition-shadow" onSubmit={handleProfileUpdate}>
          ...
          <div className="space-y-6">
            ...
            {/* Editable photographer profile fields */}
            <div>
            ...
            <div>
              ...
              <input
                ...
                type="number"
                min="0"
                value={profileFields.hourlyRate}
                onChange={handleProfileFieldsChange}
                className="w-full p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Session Rate</label>
              <input
                name="sessionRate"
                type="number"
                min="0"
                value={profileFields.sessionRate}
                onChange={handleProfileFieldsChange}
                className="w-full p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Bridal Package Rate</label>
              <input
                name="bridalPackageRate"
                type="number"
                min="0"
                value={profileFields.bridalPackageRate}
                onChange={handleProfileFieldsChange}
                className="w-full p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                placeholder="Bridal Package Rate"
                disabled={profileUpdating}
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                value={profileFields.experienceYears}
                onChange={handleProfileFieldsChange}
                className="w-full p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Specializations</label>
              <input
                ...
                disabled={profileUpdating}
              />
              <div className="text-xs text-slate-400 mt-1">Comma separated</div>
            </div>
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Brands</label>
              <input
                name="brands"
                value={profileFields.brands}
                onChange={handleProfileFieldsChange}
                className="w-full p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Offers Hair Services</label>
              <input
                name="offersHairServices"
                type="checkbox"
                checked={profileFields.offersHairServices}
                onChange={handleProfileFieldsChange}
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Travels to Client</label>
              <input
                name="travelsToClient"
                type="checkbox"
                checked={profileFields.travelsToClient}
                onChange={handleProfileFieldsChange}
                className="w-5 h-5 text-blue-600 rounded focus:ring-blue-500"
                disabled={profileUpdating}
              />
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Available Dates</label>
              <input
                name="availableDates"
                value={profileFields.availableDates}
                onChange={handleProfileFieldsChange}
                className="w-full p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                placeholder="e.g. 2024-01-01, 2024-01-15"
                disabled={profileUpdating}
              />
              <div className="text-xs text-slate-400 mt-1">Comma separated</div>
            </div>
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Package Starting Price</label>
              <input
                name="packageStartingPrice"
                value={profileFields.packageStartingPrice}
                onChange={handleProfileFieldsChange}
                className="w-full p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Price Per Person</label>
              <input
                name="pricePerPerson"
                value={profileFields.pricePerPerson}
                onChange={handleProfileFieldsChange}
                className="w-full p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
            ...
            {/* Display-only fields for user info */}
            <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
              {(profile as any)?.portfolioImages?.map((img: string) => (
                <div key={img} className="relative group">
                  <img src={img} alt="Portfolio" className="w-full h-32 object-cover rounded-xl border" />
                  <button
                    type="button"
  ...
  // Enhanced PackagesTab function with improved UI
  const PackagesTab = ({ onEdit }: { onEdit: (pkg: any | null) => void }) => (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-bold text-slate-800 flex items-center">
          <div className="w-1 h-10 bg-gradient-to-b from-blue-500 to-purple-500 rounded-full mr-4"></div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 hover:shadow-lg transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-slate-800">{packages.filter((pkg) => pkg.isActive).length}</p>
            </div>
  ...
  const handleAddPortfolioImages = async (files: File[]) => {
    ...
    try {
      for (const file of files) {
        const formData = new FormData();
        formData.append("portfolioImage", file); // Ensure correct field name
        await api.post("/photographers/portfolio/images", formData); // Do NOT set Content-Type
      }
      refreshProfile();
    } catch (err) {
  ...
  const handleDeletePortfolioImage = async (imageUrl: string) => {
    ...
    try {
      await api.delete("/photographers/portfolio/images", { data: { imageUrl } });
      refreshProfile();
    } catch (err) {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        {activeTab === "packages" && <PackagesTab onEdit={openPackageModal} />}
