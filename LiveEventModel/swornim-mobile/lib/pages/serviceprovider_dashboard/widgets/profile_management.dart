            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSectionHeader('Profile Management', Icons.person, theme, colorScheme),
                  const SizedBox(height: 16),
                  _buildProfileManagementOptions(theme, colorScheme),
                  const SizedBox(height: 32),
                  
                  // Business Section
                  _buildSectionHeader('Business Settings', Icons.business, theme, colorScheme),
                  const SizedBox(height: 16),
                  _buildBusinessOptions(theme, colorScheme),
                  const SizedBox(height: 32),
                  
                  // Portfolio Section
                  _buildSectionHeader('Portfolio & Gallery', Icons.photo_library, theme, colorScheme),
                  const SizedBox(height: 16),
                  _buildPortfolioPreview(theme, colorScheme),
                  const SizedBox(height: 32),
                  
                  // Account Section
                  _buildSectionHeader('Account & Privacy', Icons.security, theme, colorScheme),
                  const SizedBox(height: 16),
